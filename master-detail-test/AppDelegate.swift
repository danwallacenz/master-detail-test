...
class AppDelegate: UIResponder, UIApplicationDelegate, UISplitViewControllerDelegate {
    ...
    var window: UIWindow?
    let managedObjectContextFactory = ManagedObjectContextFactory(documentName: "Reports")
//        let managedObjectContextFactory = ManagedObjectContextFactory()
...
//        let managedObjectContextFactory = ManagedObjectContextFactory(documentName: "Reports")
        managedObjectContextFactory.createManagedDocument()
